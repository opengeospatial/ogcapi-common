...
The criteria for a parameter value to be considered "invalid" varies with the expressiveness of the API definition language used and the abilty of the API server to tolerate errors.  
...
The folowing requirements define how to encode a delimited list (case 2) of parameter values. They do not apply if replication (case 1) is uses.
