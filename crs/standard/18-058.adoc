:Title: OGC API-Common - Part 3: Coordinate Reference Systems by Reference
:titletext: OGC API-Common - Part 3: Coordinate Reference Systems by Reference
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/ogcapi-common-3/1.0
|Internal reference number of this OGC(R) document:    18-058
|Version: link:http://docs.opengeospatial.org/DRAFTS/18-058.html[1.0.0-SNAPSHOT (Editor's draft)]
