...
include::./REQ_rc-limit-definition.adoc[]
...
include::./REQ_rc-limit-response.adoc[]
...
include::./PER_rc-server-limit.adoc[]

include::./REC_rc-server-limit.adoc[]
...
include::./REC_rc-next-1.adoc[]

include::./REC_rc-next-2.adoc[]

include::./REC_rc-next-3.adoc[]
