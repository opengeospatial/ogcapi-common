...
include::bbox/ATS_rc-op-bbox.adoc[]

include::bbox/ATS_rc-bbox-definition.adoc[]

include::bbox/ATS_rc-bbox-response.adoc[]

==== Date-Time Tests

include::datetime/ATS_rc-op-datetime.adoc[]

include::datetime/ATS_rc-datetime-definition.adoc[]

include::datetime/ATS_rc-datetime-response.adoc[]

==== Limit Tests

include::limit/ATS_rc-op-limit.adoc[]

include::limit/ATS_rc-limit-definition.adoc[]

include::limit/ATS_rc-limit-response.adoc[]

include::limit/ATS_rc-paged-response.adoc[]
