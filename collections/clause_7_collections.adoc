...
For data reference to Earth, this `crs` will always be CRS84 or CRS84h.
...
These access mechanisms may additionally support other output CRS which are specified in the `crs` property of collection description.
