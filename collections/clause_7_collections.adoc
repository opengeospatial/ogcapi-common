...
the <<rc-umd-collection-section,Uniform Multi-Dimension Collection>> requirements class defines a specific uniform schema for properties representing additional
...
| _(if implementing <<rc-umd-collection-section,Uniform Multi-Dimension Collection>>)_ The extent for any additional dimensions beyond those described in temporal and spatial.
|===
...
| _(if implementing <<rc-umd-collection-section,Uniform Multi-Dimension Collection>>)_ Grid description providing information about the limited availability of data within the collection
...
| _(if implementing <<rc-umd-collection-section,Uniform Multi-Dimension Collection>>)_ Grid description providing information about the limited availability of data within the collection organized as a grid (regular or irregular) along the
temporal dimension.
|===
