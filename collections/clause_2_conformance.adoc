...
OGC API - Common - Part 2: Geospatial Data defines API components intended for re-use by other OGC Web API standards. For the purpose of conformance, the applicable API components are identified by <<ctc-definition,Conformance Classes>>.
...
* <<rc-uad-collections-section,Uniform Additional Dimensions Collections>>
...
The <<rc-uad-collections-section,Uniform Additional Dimensions Collections Requirements Class>> defines a consistent way to describe the domain of multidimensional collections of data,
...
Common API-2: GeoData builds on API components defined in the `OGC API - Common - Part 1: Core` (<<OGC19-072,API-Core>>) Standard.
...
| <<rc_uad-collections,Uniform Additional Dimensions Collections>>  | https://www.opengis.net/spec/ogcapi-common-2/1.0/conf/uad-collections
