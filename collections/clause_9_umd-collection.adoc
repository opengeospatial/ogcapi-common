...
The <<rc-umd-collection-section,Uniform Multi-Dimension Collection>> Requirements Class extends the <<collection-resource-definition-section,Collection>> resource to support an an unlimited number of
...
----
 interval: [0, 1]
   ...
   *       *       *    cellsCount = 3    PixelIsPoint (1 - 0) / 0.5 + 1   = 3

  [========|=======]    cellsCount = 2    PixelIsArea  (1 - 0) / 0.5       = 2
----
