...
This "Sortable Collections" defines the `sortby` query parameter which can be used with the `/collections` endpoint (described in the <<rc-collections-section,Collections>> Requirements Class)
