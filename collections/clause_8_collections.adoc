...
Examples of collections responses are provided in <<collections-metadata-examples>>.
...
.collection-properties.yaml
[source, YAML]
----
include::openapi/schemas/common-geodata/collection-properties.yaml[]
----
