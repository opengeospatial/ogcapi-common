...
Collection responses are based on the link:http://beta.schemas.opengis.net/ogcapi/common/part2/0.1/collections/openapi/schemas/collectionDesc.json[Resource Collection Schema]. Examples of Collection responses are provided in <<collection-description-examples>>.
