...
Examples of a response listing collections are provided in <<collections-list-examples>>.
...
and should always be specified this way for data referenced to Earth (independently of the native / storage reference systme of the data itself).
...
Examples of a response describing a collection are provided in <<collection-description-examples>>.
