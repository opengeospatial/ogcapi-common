...
JSON Schema for the Collections and Collection responses are available at link:http://schemas.opengis.net/ogcapi/common/part2/1.0/schemas/collections.yaml[collections.yaml] and link:http://schemas.opengis.net/ogcapi/common/part2/1.0/schemas/collectionDesc.yaml[collectionDesc.yaml].
