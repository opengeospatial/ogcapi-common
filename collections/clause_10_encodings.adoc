...
None of these encodings are mandatory. An implementation of the <<rc-collections-section,Collections>> requirements class may implement either, both, or none of them. 
