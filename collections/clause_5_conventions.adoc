...
NOTE: [OGC:CRS84] is the CURIE form for the resolvable URI http://www.opengis.net/def/crs/OGC/1.3/CRS84, [OGC:CRS84h] is the CURIE form for the resolvable URI http://www.opengis.net/def/crs/OGC/0/CRS84h.
