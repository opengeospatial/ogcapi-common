...
include::../api_modules/subset/requirements/requirements_class_subset.adoc[]
...
include::../api_modules/subset/requirements/REQ_subset-definition.adoc[]

include::../api_modules/subset/requirements/REQ_subset-success.adoc[]
...
include::requirements/subset/REQ_rc-subset-collection-response.adoc[]
