...
^|B |The content of that response SHALL be based upon the JSON schema link:http://beta.schemas.opengis.net/ogcapi/common/part2/0.1/collections/openapi/schemas/collectionDesc.json[collectionDesc.json].
