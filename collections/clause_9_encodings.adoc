...
JSON Schema for the Collections Metadata and Collection Information is available at link:http://schemas.opengis.net/ogcapi/common/part2/1.0/schemas/collections.yaml[collections.yaml] and link:http://schemas.opengis.net/ogcapi/common/part2/1.0/schemas/collectionInfo.yaml[collectionInfo.yaml].
