...
Additional information on the use of link relationships is provided in the link:http://docs.opengeospatial.org/DRAFTS/20-071.pdf[OGC API - Common Users Guide]. 
