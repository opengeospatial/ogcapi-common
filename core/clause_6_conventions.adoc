...
The individual hyperlink elements that make up a "links" element are defined using the following link:http://beta.schemas.opengis.net/ogcapi/common/part1/0.1/core/openapi/schemas/link.json[Hyperlink Schema].
...
Link relation types are expressed using the "rel" property from the link:http://beta.schemas.opengis.net/ogcapi/common/part1/0.1/core/openapi/schemas/link.json[Hyperlink Schema]. 
