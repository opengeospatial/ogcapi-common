...
Additional information on this topic is provided in the link:http://www.opengis.net/doc/UG/ogcapi-common/1.0#links-section[OGC API - Common - Users Guide].
...
Additional information on the use of HTTPS to secure API transactions is provided in the link:http://www.opengis.net/doc/UG/ogcapi-common/1.0#https-section[OGC API - Common - Users Guide].
...
Additional information on the use of OpenAPI as an API definition is provided in the link:http://www.opengis.net/doc/UG/ogcapi-common/1.0#openapi-section[OGC API - Common - Users Guide]
