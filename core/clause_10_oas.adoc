...
Additional guidance on using OpenAPI in OGC Web API implementations can be found in the link:http://docs.opengeospatial.org/DRAFTS/20-071.html#oas30-usage-section[OAPI-Common Users Guide].
