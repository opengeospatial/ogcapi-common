...
Additional guidance on using OpenAPI in OGC Web API implementations can be found in the https://github.com/opengeospatial/oapi_common/blob/master/20-071.pdf[OAPI-Common Users Guide].
