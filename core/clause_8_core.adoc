...
But first, requirements which are applicable to all OGC API standards and are not specific to a resource type are included in the <<general-requirements-section,General Requirements>> section.
