...
Additional information about Service Metadata can be found in the http://docs.opengeospatial.org/DRAFTS/20-071.html#service-metadata-section[OAPI-Common Users Guide].
