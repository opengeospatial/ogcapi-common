...
* A common `core` that is recommended for all OGC Web API implementations. This OGC API - Common - Part 1: Core Standard defines this `core` in the <<rc_core-section,Core Requirements Class>>.
