...
* [[rfc2396]] Berners-Lee, T.,Fielding, R.: **IETF RFC 2396, Uniform Resource Identifiers (URI): Generic Syntax**, http://tools.ietf.org/rfc/rfc2396.txt[http://tools.ietf.org/rfc/rfc2396.txt]
