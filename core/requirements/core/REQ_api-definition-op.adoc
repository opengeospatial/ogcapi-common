...
^|C |The responses to all HTTP GET requests issued in `A` and `B` SHALL satisfy requirement <<req_landing-page_api_definition_success,/req/landing-page/api-definition-success>>.
|===
