...
An example JSON Schema for the landing page is available at link:https://raw.githubusercontent.com/opengeospatial/oapi_common/master/core/openapi/schemas/landingPage.yaml[landingPage.yaml].
