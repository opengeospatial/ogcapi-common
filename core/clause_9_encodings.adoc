...
An example JSON Schema for the landing page is available at link:beta.schemas.opengis.net/ogcapi/common/part1/0.1/core/openapi/schemas/landingPage.json[landingPage.json].

An example JSON Problem Details report is available at link:beta.schemas.opengis.net/ogcapi/common/part1/0.1/core/openapi/examples/ExceptionExample.json[ExceptionExample.json].
