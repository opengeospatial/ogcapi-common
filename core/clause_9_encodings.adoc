...
Neither of these encodings are mandatory. An implementation of the <<rc_core-section,Core>> requirements class may implement one, both, or none of them. Other encodings are possible.
...
An example JSON Problem Details report is available at link:https://github.com/opengeospatial/oapi_common/blob/master/core/openapi/examples/ExceptionExample.json[ExceptionExample.json].
