...
An example JSON Schema for the landing page is available at link:https://github.com/opengeospatial/oapi_common/blob/master/core/openapi/schemas/landingPage.yaml[landingPage.yaml].
