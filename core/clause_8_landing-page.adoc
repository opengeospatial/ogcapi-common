...
Additional information about the Landing Page can be found in the link:http://www.opengis.net/doc/UG/ogcapi-common/1.0#landing-page-section[OGC API - Common - Users Guide].
