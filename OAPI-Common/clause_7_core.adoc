...
include::recomendations/core/REC_rc-md-descriptions.adoc[]
...
include::recomendations/core/PER_rc-md-items.adoc[]
...
include::recomendations/core/REC_rc-md-extent-single.adoc[]

include::recomendations/core/PER_rc-md-extent-extensions.adoc[]
