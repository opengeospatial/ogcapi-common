...
There is no requirement that every OGC API support Geospatial Resources. Therefore, Geospatial Resources are addressed in a separate `Collections` Requirement Class. This class is described in Section 9.
...
The OGC API Information Resource types and their corresponding API standard are provided in <<information_resource_table>>

[#information_resource_table,reftext='{table-caption} {counter:table-num}']
