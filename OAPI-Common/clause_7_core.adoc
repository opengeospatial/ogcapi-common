...
There is no requirement that every OGC API support Geospatial Resources. Therefore, Geospatial Resources are addressed in a separate `Collections` Requirement Class. This class is described in Section 8.
