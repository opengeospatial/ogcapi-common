...
[NOTE]
=====================================================================
Add a discussion of required vs. optional paths and the presence of both standard paths and links on the landing page.

In particular, /conformace is the only required path.
=====================================================================
...
NOTE]
=====================================================================
To discuss: what resources can lay beyond /collections/{collectionId}?  If there can be more than one resource, then we need to identify the resource type in the path (items). For example, exploitation metadata for a coverage may be a separate resource from the coverage itself. So we would have /{collectionId}/items and /{collectionId}/metadata. 
=====================================================================
