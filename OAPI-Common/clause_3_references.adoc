...
* Open API Initiative: **OpenAPI Specification 3.0.1**, https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.1.md[https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.1.md]
* Fielding, R., Gettys, J., Mogul, J., Frystyk, H., Masinter, L., Leach, P., Berners-Lee, T.: **IETF RFC 2616, HTTP/1.1**, http://tools.ietf.org/rfc/rfc2616.txt[http://tools.ietf.org/rfc/rfc2616.txt]
* Rescorla, E.: **IETF RFC 2818, HTTP Over TLS**, http://tools.ietf.org/rfc/rfc2818.txt[http://tools.ietf.org/rfc/rfc2818.txt]
