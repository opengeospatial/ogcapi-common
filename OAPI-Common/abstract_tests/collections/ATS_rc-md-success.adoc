...
^|Requirement |<<req_collections_rc-md-success,/req/collections/rc-md-success>>, <<req_core_crs84,/req/core/crs84>>
...
|HTML |link:https://raw.githubusercontent.com/opengeospatial/oapi_common/blob/master/OAPI-Common/openapi/schemas/collections.yaml[collections.yaml] |<<ats_html_content,/ats/html/content>>
|GeoJSON |link:https://raw.githubusercontent.com/opengeospatial/oapi_common/blob/master/OAPI-Common/openapi/schemas/collections.yaml[collections.yaml] |<<ats_geojson_content,/ats/geojson/content>>
|===
