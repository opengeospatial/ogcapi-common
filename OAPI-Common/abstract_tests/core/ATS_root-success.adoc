...
|HTML |link:https://raw.githubusercontent.com/opengeospatial/oapi_common/blob/master/OAPI-Common/openapi/schemas/landingPage.yaml[landingPage.yaml]
|<<ats_html_content,/ats/html/content>>
|GeoJSON |link:https://raw.githubusercontent.com/opengeospatial/oapi_common/blob/master/OAPI-Common/openapi/schemas/landingPage.yaml[landingPage.yaml] |<<ats_geojson_content,/ats/geojson/content>>
|===
