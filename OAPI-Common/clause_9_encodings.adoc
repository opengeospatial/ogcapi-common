...
Neiter of these encodings are mandatory and an implementation of the <<rc_core-section,Core>> requirements class may implement either, both, or none of them. <<overview,Clause 6 (Overview)>> includes a discussion about recommended encodings.
