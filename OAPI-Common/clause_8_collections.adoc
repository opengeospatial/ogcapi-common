...
The OGC API-Common standard does not define any Information Resource types. However <<information-resource-table>> provides a maping of the know Information Resource types to the standard where they are defined.
