...
Direct access is the use of know URL paths to access a resource directly. The requirements in this Requirement Class are organized arount the standard path for Geospatial Data. 
...
include::recommendations/collections/REC_path-conventions.adoc[]
...
The `collections` property of the Collections Metadata is based on the schema described in <<collection-information>>. The following requirements and recommendations govern the use of Collection Information in the Collections Metadata.
...
Collection Information is based on the link:https://raw.githubusercontent.com/opengeospatial/OAPI_Common/master/core/openapi/schemas/collectionInfo.json[Collection Information Schema] Schema.
...
Information Resources related to Geospatial Resources can exposed using two path templates:
