...
These are the only _enum_ values in link:https://raw.githubusercontent.com/opengeospatial/oapi_common/master/standard/openapi/schemas/extent.yaml[extent.yaml]).
