...
NOTE: ISSUE: Should OGC API standards be organized by concept? See issue https://github.com/opengeospatial/oapi_common/issues/86[86].
...
[#information-resource-table,reftext='{table-caption} {counter:table-num}']
...
NOTE: ISSUE: Should we expand our explantion of HTTP status codes? See issues https://github.com/opengeospatial/oapi_common/issues/75[75], and https://github.com/opengeospatial/oapi_common/issues/73[73].
...
NOTE: ISSUE: Is this discussion of content negotiation sufficient? If not, what else do we need? See issues https://github.com/opengeospatial/oapi_common/issues/57[57] and https://github.com/opengeospatial/oapi_common/issues/28[28].
