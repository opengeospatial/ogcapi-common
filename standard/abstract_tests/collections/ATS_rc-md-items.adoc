...
|HTML |link:https://raw.githubusercontent.com/opengeospatial/oapi_common/blob/master/standard/openapi/schemas/collection.yaml[collection.yaml] |Manual Inspection
|GeoJSON |link:https://raw.githubusercontent.com/opengeospatial/oapi_common/blob/master/standard/openapi/schemas/collection.yaml[collection.yaml] |<<ats_geojson_content,/ats/geojson/content>>
|===
