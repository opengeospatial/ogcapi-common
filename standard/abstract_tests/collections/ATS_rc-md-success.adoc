...
|HTML |link:https://raw.githubusercontent.com/opengeospatial/oapi_common/blob/master/standard/openapi/schemas/collections.yaml[collections.yaml] |<<ats_html_content,/ats/html/content>>
|GeoJSON |link:https://raw.githubusercontent.com/opengeospatial/oapi_common/blob/master/standard/openapi/schemas/collections.yaml[collections.yaml] |<<ats_geojson_content,/ats/geojson/content>>
|===
