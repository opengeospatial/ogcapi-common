...
This is discussed in detail in <<SDWBP,W3C Best Practice 2>>. This standard therefore <<rec_html,recommends>> supporting HTML as an encoding.
...
Templates for the definition of the schemas for the GeoJSON responses in JSON Schema definitions are available at link:https://github.com/opengeospatial/oapi_common/tree/master/standard/openapi/schemas[collectionsGeoJSON.yaml] and link:https://github.com/opengeospatial/oapi_common/tree/master/standard/openapi/schemas[collectionInfoGeoJSON.yaml].
