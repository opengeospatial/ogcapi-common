...
Templates for the definition of the schemas for the GeoJSON responses in JSON Schema definitions are available at link:https://raw.githubusercontent.com/opengeospatial/oapi_common/master/standard/openapi/schemas/collectionGeoJSON.yaml[collectionsGeoJSON.yaml] and link:https://raw.githubusercontent.com/opengeospatial/oapi_common/master/standard/openapi/schemas/CollectionInfoGeoJSON.yaml[collectionInfoGeoJSON.yaml].
