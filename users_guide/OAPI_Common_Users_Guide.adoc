:Title: OGC API-Common Users Guide
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/EG/ogcapi-common/1.0
|Internal reference number of this OGC(R) document:    20-071
|Version: n.n
...
[width = "50%", grid = "none"]
|===
|Document type:   OGC(R) Engineering Guidance
|Document subtype:
...
include::clause_6_users-guide.adoc[]
