...
For example, `sd=../200000` (or `sd=/200000`) would only match collections with data intended for a scale of 1:200,000 or larger (e.g., collections intended for 1:2,000,000 would be excluded).
