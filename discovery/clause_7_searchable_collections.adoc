...
The `query` parameter is similar to the `q` parameter, but additionally specifies the use of the `+++` character following a space and appearing before a term to indicate that this additional term must also be present,
