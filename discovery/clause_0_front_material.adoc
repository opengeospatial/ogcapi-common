...
A portion of this document has been derived from OGC API - Records - Part 1: Core and generalized to any data access mechanism.
Since the content was actually embedded within this document, OGC API - Records is not cited as a normative reference.
