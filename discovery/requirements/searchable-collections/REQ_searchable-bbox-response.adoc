...
part:: If the `bbox` query parameter is provided by the client, then only collections that have a spatial extent that intersects the bounding box and collections that
