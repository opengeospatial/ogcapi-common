...
OGC API - Common Part 2 defines an optional `parent` property to include in the collection description resources (`/collections/{collectionId}`)
...
CAUTION: Clients need to primarily rely on the use of the <<req_hierarchy_parent-property,`parent` property>> for establishing a hierarchy.
The corresponding `parent` link relation is provided for alignment with other standards such as
...
include::requirements/hierarchical-collections/REQ_children_links.adoc[]

Examples of collection description responses for `/collections/{collectionId}`:
...
----
{
   ...
   "parent": "Canada",
   "links": [
      { "rel": "self", "/collections/Quebec" },
      { "rel": "[ogc-rel:map]", "href": "/collections/Quebec/map" },
      { "rel": "[ogc-rel:children]", "href": "/collections?parent=Quebec&descendants=immediate" }
   ],
   ...
}
----
   ...
   "collections": [
      {
         ...
         "links": [
            { "rel": "self", "href": "/collections/Canada" },
            { "rel": "[ogc-rel:map]", "href": "/collections/Canada/map" },
            { "rel": "[ogc-rel:children]", "href": "/collections?parent=Canada&descendants=immediate" }
         ]
      },
      {
         "id": "USA",
         "links": [
            { "rel": "self", "href": "/collections/USA" },
            { "rel": "[ogc-rel:map]", "href": "/collections/USA/map" },
            { "rel": "[ogc-rel:children]", "href": "/collections?parent=USA&descendants=immediate" }
         ]
      }
   ]
   ...
   ...
   "collections": [
      ...
      },
      {
         ...
         "links": [
            ...
            { "rel": "[ogc-rel:map]", "href": "/collections/Ontario/map" },
            { "rel": "[ogc-rel:tilesets-vector]", "href": "/collections/Ontario/tiles" },
            { "rel": "[ogc-rel:children]", "href": "/collections?parent=Ontario&descendants=immediate" }
         ]
      }
   ]
   ...
